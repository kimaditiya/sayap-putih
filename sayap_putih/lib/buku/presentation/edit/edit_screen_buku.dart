...
import 'package:sayap_putih/buku/presentation/edit/edit_buku.dart';
...
class EditBuku extends StatefulWidget {
  ...
  EditBuku({Key? key,required this.paging,required this.buku}) : super(key: key);
          ...
          switch (snapshot.connectionState) {
            ...
            default:
              if (snapshot.hasError)
                ...
                return EditFormBuku(paging: widget.paging, listgenre: snapshot.data![0], listpengarang: snapshot.data![1],buku:widget.buku);
          }
        },
      )
    );
