...
class EditFormMember extends StatefulWidget {
  ...
  EditFormMember({Key? key, required this.paging,required this.listgenre,required this.listpengarang,required this.member}) : super(key: key);


  @override
  _EditFormMemberState createState() => _EditFormMemberState();
}

class _EditFormMemberState extends State<EditFormMember> {
  ...
  Future<String?> usertoken() async {
    ...
    return token;
      ...
      @override
  void initState() {
    controllerTglLahir.text = widget.member.tanggalLahir;
    _namaController.text = widget.member.nama;
    _alamatController.text = widget.member.alamat;

    _genre  = Genre(id: widget.member.genre.first.id,name: widget.member.genre.first.name);
     _penggarang  = Pengarang(id: widget.member.pengarang.first.id,nama: widget.member.pengarang.first.name,tanggalLahir: widget.member.tanggalLahir);
    super.initState();
                ...
                Expanded(
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      await http.put(Uri.parse('https://soal.holywings.com/member/${widget.member.id}')
