...
import 'package:sayap_putih/member/create/form_member.dart';
...
class AddMember extends StatefulWidget {
  ...
  AddMember({Key? key,required this.paging}) : super(key: key);
          ...
          switch (snapshot.connectionState) {
            ...
            default:
              if (snapshot.hasError)
                ...
                return FormMember(paging: widget.paging, listgenre: snapshot.data?[0], listpengarang: snapshot.data?[1]);
          }
        },
      )
    );
