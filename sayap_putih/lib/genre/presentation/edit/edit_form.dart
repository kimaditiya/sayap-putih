...
class EditGenre extends StatefulWidget {
  ...
  EditGenre({Key? key, required this.paging, @required this.genre}) : super(key: key);
...
class _EditGenreState extends State<EditGenre> {
  ...
  void initState() {
    super.initState();
    _namaController.text = widget.genre!.name;
    formData2['id'] = widget.genre!.id;
                ...
                Expanded(
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      await dio.put('https://soal.holywings.com/genre', data: formData
