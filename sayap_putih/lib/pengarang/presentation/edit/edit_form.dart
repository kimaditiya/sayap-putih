...
class EditForm extends StatefulWidget {
  ...
  EditForm({Key? key, required this.paging,@required this.listgenre,@required this.pengarang}) : super(key: key);
...
class _EditFormState extends State<EditForm> {
  ...
  void initState() {
    super.initState();
    _genre  = Genre(id: widget.pengarang!.genre!.id,name: widget.pengarang!.genre!.name);
     controllerTglLahir.text = widget.pengarang!.tanggalLahir;
     _namaController.text = widget.pengarang!.nama;
                ...
                Expanded(
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      await http.put(Uri.parse('https://soal.holywings.com/pengarang/${widget.pengarang!.id}')
