...
import 'package:sayap_putih/pengarang/presentation/create/form_pengarang.dart';
import 'package:shared_preferences/shared_preferences.dart';


class AddPengarang extends StatefulWidget {

  final PagingController<int, Pengarang> paging;
 
  AddPengarang({Key? key,required this.paging}) : super(key: key);
  
  @override
  _AddPengarangState createState() => _AddPengarangState();
}

class _AddPengarangState extends State<AddPengarang> {
          ...
          switch (snapshot.connectionState) {
            ...
            default:
              if (snapshot.hasError)
                ...
                return FormAdd(paging: widget.paging, listgenre:  snapshot.data);
          }
        },
      )
    );
